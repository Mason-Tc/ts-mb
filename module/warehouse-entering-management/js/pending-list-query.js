define(function(require, module, exports) {
	...
	m.init({
		...
		//			//触发父页面的自定义事件(getPendingListFilterVal),从而进行刷新
		//			mui.fire(warehouseEnteringManagementPage, 'getPendingListFilterVal', {
		//				"carNo": globalVue.sureVal.carNo,
		//				"forecastCode": globalVue.sureVal.forecastCode,
	...
	var globalVue = new Vue({
		...
		methods: {
			...
			sure: function() {
				this.sureVal.packageNo = this.packageNo;
				this.sureVal.carNo = this.carNo;
				this.sureVal.forecastCode = this.forecastCode;
				...
				//触发父页面的自定义事件(getPendingListFilterVal),从而进行刷新
				m.fire(warehouseEnteringManagementPage, 'getPendingListFilterVal', {
					"packageNo": this.sureVal.packageNo,
					"carNo": this.sureVal.carNo,
					"forecastCode": this.sureVal.forecastCode,
					"ownerId": this.sureVal.ownerId,
					"ownerName": this.sureVal.ownerName,
					"brandId": this.sureVal.brandId,
					"brandName": this.sureVal.brandName,
					"beginDate": this.sureVal.beginDate,
					"endDate": this.sureVal.endDate
				});
				m.back();
			}
		}
	...
	m.plusReady(function() {
		...
		globalVue.packageNo = filterConditions.packageNo;
		globalVue.carNo = filterConditions.carNo;
		globalVue.forecastCode = filterConditions.forecastCode;
		...
		//子页面要传给父页面的值
		globalVue.sureVal.packageNo = filterConditions.packageNo;
		globalVue.sureVal.carNo = filterConditions.carNo;
		globalVue.sureVal.forecastCode = filterConditions.forecastCode;
