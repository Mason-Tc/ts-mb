    ...
    init: function(mainEl, chart, opt) {
      ...
      function resize(x, y, isInit) {
        ...
        if (isInit || !opt.lockX) {
          ...
          mainEl.css("width", mainContentWidth + borderBoxBroder + "px");
        }
        ...
        if (isInit || !opt.lockY) {
          ...
          mainEl.css("height", mainContentHeight + borderBoxBroder + "px");
        }

        label.text(
          Math.round(mainContentWidth) + " x " + Math.round(mainContentHeight)
        );
